...
export enum DistributionPointPostConnectionType {
    Smb = "SMB",
    Afp = "AFP",
}

export enum DistributionPointPostProtocol {
    Http = "http",
    Https = "https",
}

export class DistributionPointPost extends SpeakeasyBase {
    @SpeakeasyMetadata()
    @Expose({ name: "connection_type" })
    connectionType?: DistributionPointPostConnectionType;
    ...
    /**
     * Name of a file distribution point or "Cloud Distribution Point" to use as failover.
     */
    @SpeakeasyMetadata()
    ...
    protocol?: DistributionPointPostProtocol;

 ...
 */
export enum CreateMobileDeviceCommandRequestBodyGeneralCommand {
    Settings = "Settings",
...
export class CreateMobileDeviceCommandRequestBodyGeneral extends SpeakeasyBase {
    /**
...
export class CreateMobileDeviceCommandRequestBodyMobileDevicesMobileDevice extends SpeakeasyBase {
    @SpeakeasyMetadata()
    id: number;
}

export class CreateMobileDeviceCommandRequestBodyMobileDevices extends SpeakeasyBase {
    @SpeakeasyMetadata()
    mobileDevice?: CreateMobileDeviceCommandRequestBodyMobileDevicesMobileDevice;
}

export class CreateMobileDeviceCommandRequestBody extends SpeakeasyBase {
    @SpeakeasyMetadata()
...
export class CreateMobileDeviceCommandResponse extends SpeakeasyBase {
    @SpeakeasyMetadata()
    contentType: string;

...
export enum FindMobileDeviceCommandsAcceptEnum {
    applicationJson = "application/json",
    applicationXml = "application/xml",
}

export enum FindMobileDeviceCommandsByCommandAcceptEnum {
    applicationJson = "application/json",
    applicationXml = "application/xml",
}

export enum FindMobileDeviceCommandsByNameAcceptEnum {
    applicationJson = "application/json",
    applicationXml = "application/xml",
}

export enum FindMobileDeviceCommandsByUuidAcceptEnum {
    applicationJson = "application/json",
    applicationXml = "application/xml",
}
...
export class Mobiledevicecommands {
    ...
    async createMobileDeviceCommand(
        ...
        const operationUrl: string = baseURL.replace(/\/$/, "") + "/mobiledevicecommands/command";
    ...
    async findMobileDeviceCommands(
        config?: AxiosRequestConfig,
        acceptHeaderOverride?: FindMobileDeviceCommandsAcceptEnum
    ): Promise<operations.FindMobileDeviceCommandsResponse> {
        const baseURL: string = utils.templateUrl(
            this.sdkConfiguration.serverURL,
            this.sdkConfiguration.serverDefaults
        );
        const operationUrl: string = baseURL.replace(/\/$/, "") + "/mobiledevicecommands";
        const client: AxiosInstance = this.sdkConfiguration.defaultClient;
        let globalSecurity = this.sdkConfiguration.security;
        if (typeof globalSecurity === "function") {
            globalSecurity = await globalSecurity();
    ...
    async findMobileDeviceCommandsByCommand(
        ...
        config?: AxiosRequestConfig,
        acceptHeaderOverride?: FindMobileDeviceCommandsByCommandAcceptEnum
    ...
    async findMobileDeviceCommandsByName(
        ...
        config?: AxiosRequestConfig,
        acceptHeaderOverride?: FindMobileDeviceCommandsByNameAcceptEnum
    ...
    async findMobileDeviceCommandsByUuid(
        ...
        config?: AxiosRequestConfig,
        acceptHeaderOverride?: FindMobileDeviceCommandsByUuidAcceptEnum

...
export class Accounts {
    ...
    async createAccountById(
        ...
        const operationUrl: string = utils.generateURL(baseURL, "/accounts/userid/{id}", req);
    ...
    async createGroupById(
        ...
        const operationUrl: string = utils.generateURL(baseURL, "/accounts/groupid/{id}", req);
        const client: AxiosInstance = this.sdkConfiguration.defaultClient;
        let globalSecurity = this.sdkConfiguration.security;
        if (typeof globalSecurity === "function") {
            globalSecurity = await globalSecurity();
    ...
    async deleteAccountByName(
        ...
        const operationUrl: string = utils.generateURL(baseURL, "/accounts/username/{name}", req);
        const client: AxiosInstance = this.sdkConfiguration.defaultClient;
        let globalSecurity = this.sdkConfiguration.security;
        if (typeof globalSecurity === "function") {
            globalSecurity = await globalSecurity();
    ...
    async deleteGroupByName(
        ...
        const operationUrl: string = utils.generateURL(baseURL, "/accounts/groupname/{name}", req);
        const client: AxiosInstance = this.sdkConfiguration.defaultClient;
        let globalSecurity = this.sdkConfiguration.security;
        if (typeof globalSecurity === "function") {
            globalSecurity = await globalSecurity();
